...
//        Set<String> allNames = favoriteColors.get()

        ArrayList<String> favoriteColorBlue = new ArrayList<>();
        ArrayList<String> favoriteColorRed = new ArrayList<>();
        ArrayList<String> favoriteColorGreen = new ArrayList<>();
