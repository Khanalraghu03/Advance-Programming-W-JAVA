...
public class GanttCanvas extends Jeli.Widgets.JeliTransferCanvas
{
  public Vector gantt_list;
  private static double defaultMillisecondsPerPixel = 100.0D;
  private static int defaultFrameHeight = 10;
  private static int defaultFrameOffset = 2;
  private static int defaultKeyBarLength = 0;
  private static int defaultLabelGridSkip = 1;
  private static long defaultForceGridIncrement = 0L;
  private static Color defaultTextColor = Color.black;
  private static Color defaultBackColor = Color.white;
  private static Color defaultGridTextColor = Color.gray;
  private static Color defaultGridSkipColor = Color.lightGray;
  int thiswidth;
  int thisheight;
  Color text_color;
  ...
  long grid_increment;
  long force_grid_increment = 0L;
  int label_grid_skip = 1;
  long grid_init = 0L;
  double last_end_time;
  double last_end_time_display;
  String last_string;
  ...
  public GanttCanvas(Vector gantt_list, GanttChart gchart)
  {
    this.gchart = gchart;
  ...
  {
    milliseconds_per_pixel = defaultMillisecondsPerPixel;
    frame_height = defaultFrameHeight;
    frame_offset = defaultFrameOffset;
    keyBarLength = defaultKeyBarLength;
    label_grid_skip = defaultLabelGridSkip;
    force_grid_increment = defaultForceGridIncrement;
    text_color = defaultTextColor;
    back_color = defaultBackColor;
    grid_text_color = defaultGridTextColor;
    light_grid_text_color = defaultGridSkipColor;
  }
  
  public void setDefaultsFromCurrent() {
    defaultMillisecondsPerPixel = milliseconds_per_pixel;
    defaultFrameHeight = frame_height;
    defaultFrameOffset = frame_offset;
    defaultKeyBarLength = keyBarLength;
    defaultLabelGridSkip = label_grid_skip;
    defaultForceGridIncrement = force_grid_increment;
  }
  ...
  public void draw_all_to_background()
  {
    ...
    for (int i = 0; i < gantt_list.size(); i++) {
      GanttInfo ginfo = (GanttInfo)gantt_list.elementAt(i);
    ...
    for (int i = 0; i < gantt_list.size(); i++) {
      ...
      double frame_start = start - frame_fix;
      double frame_end = end - frame_fix;
  ...
  public void setForceGridIncrement(long fgi) {
    force_grid_increment = fgi;
  }
  ...
  public Color getGridSkipColor() {
    return light_grid_text_color;
  }
  ...
  public int getKeyBarLength() {
    return keyBarLength;
  }
  
  public int getLabelGridSkip() {
    return label_grid_skip;
  }
  
  public int getForceGridIncrement() {
    return (int)force_grid_increment;
  }
  ...
  public void autoScale()
  {
    ...
    {
      double ms = (last_time - first_time + denom - 1.0D) / denom;
      if (ms < 1.0D) ms = 1.0D;
      gchart.setMS(ms);
      milliseconds_per_pixel = ms;
    }
  ...
  public void setGridTextColor(Color c) {
    grid_text_color = c;
    GridTextGC.setColor(c);
    repaint();
  }
  
  public void setGridSkipColor(Color c) {
    light_grid_text_color = c;
    LightGridTextGC.setColor(c);
    repaint();
  }
  ...
  private void handleCheatCode()
  {
    ...
    if (tok.equalsIgnoreCase("Change"))
    {
      if (!stk.hasMoreTokens()) {
        System.out.println("Must implement change");
      }
    }
  ...
  private void showGanttList()
  {
    ...
    for (int i = 0; i < gantt_list.size(); i++) {
      GanttInfo info = (GanttInfo)gantt_list.elementAt(i);
  ...
  protected void setLabelGridSkip(int n) {
    label_grid_skip = n;
    if (label_grid_skip <= 0)
      label_grid_skip = 1;
  }
  ...
  protected void setToHeight()
  {
    int max = 0;
    for (int i = 0; i < gantt_list.size(); i++) {
      GanttInfo gi = (GanttInfo)gantt_list.elementAt(i);
