...
public class GanttChartI extends JeliFrame implements Jeli.Widgets.SliderCallBack, SaveImageInfo, LogState, Jeli.Widgets.JeliColorButtonCallBack
{
  ...
  protected GanttCanvasI draw_canvas;
  ...
  public GanttChartI(String Name, Vector gantt_list, Logger logger, HelpManager hm)
  {
    this(Name, gantt_list, logger, hm, 600, 300);
  }
  
  public GanttChartI(String Name, Vector gantt_list, Logger logger, HelpManager hm, int w, int h)
  {
    super(Name);
    this.Name = Name;
  ...
  void setup_layout()
  {
    ...
    draw_canvas = new GanttCanvasI(gantt_list, this);
    draw_canvas.set_ms(init_milliseconds_per_pixel);
  ...
  public void change_parameters()
  {
    if (MillisecondsPerPixel != null) {
      double ms = MillisecondsPerPixel.valueDouble();
      draw_canvas.set_ms(ms);
      int fh = BarHeight.value();
      draw_canvas.set_frame_height(fh);
      draw_canvas.set_frame_increment(BarInc.value());
      draw_canvas.repaint();
    }
  }
  
  public void setMS(double ms) {
    MillisecondsPerPixel.set_value(ms);
  }
  ...
  public void autoScale() {
    ...
    if (MillisecondsPerPixel != null) {
      MillisecondsPerPixel.set_value(draw_canvas.get_ms());
    }
  }
  ...
  public static Color getMonoColor(int n) {
    return GanttCanvasI.getMonoColor(n);
  }
